...
# (e.g. the Riksbank labels pre-1999 ECU values as EUR). RateValidation relabels these rows with the known predecessor
# and drops them only when there is no predecessor to identify.
